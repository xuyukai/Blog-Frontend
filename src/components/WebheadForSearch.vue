  ...
  <div>
    ...
    <div class="opacitybar">
      <el-menu  :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true"  active-text-color="#ffd04b">
        ...
        <el-menu-item style="margin-left: 56%" class="hidden-xs-only" v-if="this.$store.state.token ==''"  index=""
        ...
        <el-submenu style="margin-left:60%; " class="hidden-xs-only" index="2" v-if="this.$store.state.token!==''" :router="true">
    ...
    <div style="width: 20%; margin-top:60px; margin-left:58.5%;opacity: 0.8" class="hidden-xs-only">
      <el-input placeholder="快来试试搜索吧！" v-model="searchTxt" suffix-icon="el-icon-search"
